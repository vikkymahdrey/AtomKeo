...
function modifysch(id,time,date,idvar,logtype){
	var mtime=$('#'+idvar).val();
	 $.ajax({url:"modifytrip?schid="+id+"&date="+date+"&time="+mtime+"&oldtime="+time+"&logtype="+logtype,type : "GET", success: function(result){
		 if(result=="true"){
