...
public interface TripDetailsService {
	...
	int modifyTrip(LinkedHashMap<String, ArrayList<ModifyTripDto>> modifiedList,String[] tripIds, String id, String tripMode, String siteId,
																					String tripTime, String tripDate)throws Exception;
	int addNewtrip(ArrayList<ModifyTripDto> addList, String id,String tripMode, String siteId, String tripTime, String tripDate)throws Exception;
	void deleteEmptyTripIds(String string)throws Exception;
