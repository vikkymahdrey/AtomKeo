<%-- 
<%@page import="com.agiledge.atom.config.files.SettingsConstant"%>
<%@page import="com.agiledge.atom.config.files.OtherFunctions"%>
<%@page import="com.itextpdf.text.log.SysoLogger"%>
<%@page import="java.util.Date"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.agiledge.atom.entities.Site"%>
<%@page import="com.agiledge.atom.entities.EmployeeSchedule"%>
<%@page import="com.agiledge.atom.entities.Logtime"%>
<%@page import="com.agiledge.atom.service.intfc.ShiftService"%>
...
//	String manager = request.getParameter("supervisorID1");
	...
	List<EmployeeSchedule> emplist = (List<EmployeeSchedule>) request.getAttribute("emplist");
	...
	session.setAttribute("shiftInValue", shiftInValue);
	session.setAttribute("shiftOutValue", shiftOutValue);
	...
	<div id="body">
		<div class="content">
			<div>
				<form name="form1" action="ddisplayempschreport" method="POST"
						...
						<tr>
							...
							String site=(request.getSession().getAttribute("site")==null||request.getSession().getAttribute("site").toString().trim().equals(""))?"" :request.getSession().getAttribute("site").toString().trim();
								...
								%>
									...
									<option <%=siteSelect %> value="<%=sites.getId()%>"><%=sites.getSiteName()%></option>
									<%  }%>
							</select></td>
