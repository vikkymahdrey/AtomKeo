...
public class Escort implements Serializable {
	...
	@OneToMany(mappedBy="escort")
	private List<Tripshuttle> tripshuttles;
...
public List<Tripshuttle> getTripshuttles() {
		return this.tripshuttles;
	}

	public void setTripshuttles(List<Tripshuttle> tripshuttles) {
		this.tripshuttles = tripshuttles;
	}

	public Tripshuttle addTripshuttle(Tripshuttle tripshuttle) {
		getTripshuttles().add(tripshuttle);
		tripshuttle.setEscort(this);

		return tripshuttle;
	}

	public Tripshuttle removeTripshuttle(Tripshuttle tripshuttle) {
		getTripshuttles().remove(tripshuttle);
		tripshuttle.setEscort(null);
