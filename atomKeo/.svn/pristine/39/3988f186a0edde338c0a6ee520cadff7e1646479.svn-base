	...
	<div id="body">
		<div class="content">
			...
			<%
						...
						ArrayList<TripDetailsDto> tripSheetListActual = (ArrayList<TripDetailsDto>)request.getAttribute("tripSheetListActual");
					%>

			<hr />
			<h3>Modified Trip Sheet</h3>
			<form name="form1" action="modifyTrip" method="POST"
