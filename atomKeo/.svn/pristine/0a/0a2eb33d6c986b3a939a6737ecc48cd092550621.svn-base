...
@Service
public class LoadSettingServiceImpl implements LoadSettingService {

	@Autowired
	private LoadSettingsDao loadSettingsDao;
	
	public void loadAllPageViewSettingsDefaults() throws Exception {
		// truncate all tables related to page and page_role autherisation
		if (loadSettingsDao.truncateAllPageRoleTables() == 6) {
			// 1. adding pages
			addPages();
			// 2. set Home pages
			setHomePage_Default();
			...
			loadSettingsDao.loadPageRole_Default();
			// 7. fill data in menu_url table for page access
			loadSettingsDao.loadMenu_Url_Default();
		}
	...
	public void addPages() throws Exception {
		...
		loadSettingsDao.loadPage_Default(dtoList);

	}
	
	
	public PageDto templateToPageDtoForLoadPage_Default(String[] template) {
	...
	public void setHomePage_Default() throws Exception {
		...
		loadSettingsDao.setHomePage_Default(dtoList);

	}
	
	public PageDto templateToPageDtoForSetHomePage_Default(String[] template) {
		PageDto dto = new PageDto();
		dto.setUrl(template[0]);
	...
	public void loadViews_Default()  throws Exception{
		...
		loadSettingsDao.loadViews_Default(dtoList);

	}
	
	private ViewManagementDto templateToPageDtoForLoadViews_Default(String[] template) throws Exception {
	...
	public void loadSubViews_Default() throws Exception {
		...
		loadSettingsDao.loadSubViews_Default(dtoList);

	
}
	
	public ViewManagementDto templateToPageDtoForLoadSubViews_Default(String[] template) throws Exception {
		ViewManagementDto dto = new ViewManagementDto();
	...
	public void loadRolesViewsAssociation_Default() throws Exception {
		...
		loadSettingsDao.loadRolesViewsAssociation_Default(dtoList);

	}
	
	public ViewManagementDto templateToPageDtoForLoadRolesViewsAssociation_Default(String[] template) throws Exception{
		ViewManagementDto dto = new ViewManagementDto();
