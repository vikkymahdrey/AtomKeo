...
{
	private static final Logger logger = Logger.getLogger(SettingsConstant.class);
    ...
    static {
    	logger.debug("SettingsConstant Initialisation");
    ...
    public static void setCompany()
    {
        ...
        if(comp.equalsIgnoreCase("cdtemp1"))
        {
            ...
            dayreportBean = "DayreportBeancd1";
            showDesigOrRole = "role";
        } else if(comp.equalsIgnoreCase("visa"))
            {
                 ...
                 getEmpSource = "uat";
                 emailForScheduleEmployee = "no";
                 //url = "jdbc:mysql://localhost:3306/atomcoredemo2";
        	...
        	else if(comp.equalsIgnoreCase("keo"))
            {
                transportTeamNumber = "9620300915";
                transportTeamEmail = "vikky@agiledgesolutions.com";
                emailFlag = "gss";
