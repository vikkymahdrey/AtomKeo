...
public class getMessages {
	...
	public static String getEscortSMSMsg(String tripDate,String tripTime, String escortName,String vehicle, String driverPswd,String tripCode) throws Exception {
		String message = "Date:"+tripDate+", Logout time: "+tripTime+", PIN # "+driverPswd+",Vehicle # "+vehicle+". Regds, Transport Team.";
		return message;
	}
}
