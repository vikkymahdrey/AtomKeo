...
/**
 * The persistent class for the trip_details_child database table.
 * 
 */
@Entity
@Table(name="trip_details_child")
@NamedQuery(name="TripDetailsChild.findAll", query="SELECT t FROM TripDetailsChild t")
public class TripDetailsChild implements Serializable {
