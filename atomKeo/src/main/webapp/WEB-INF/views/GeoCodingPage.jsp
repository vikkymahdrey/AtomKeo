...
<html lang="en">
  <head>
    ...
    <title>Employee Geo Tagging</title>
	...
	<div class="main-page-container">
		<div class="container">	
			<div class="row">
				...
				<form action="geoCodingUpdate" id="UserDetails" method="post"
				onsubmit="return validate();">
				
					<div class="row">
						<div class="col-sm-8 page-heading mar-top-20">
							<i class="page-heading-icon"><img src="images/edit_profile.png" /></i>
							<h5 class="text-blue text-semi-bold " id="hdtext">Please Geo code your home location to complete the registration.</h5>
						</div>
				...
				<div class="row mar-top-20">
					...
					<div class="col-md-5 col-sm-12 col-md-offset-2">
							...
							<div class="col-md-3 col-sm-7 col-xs-6 mar-top-15"> <input
							type="hidden" name="homelatlong" id="homelatlong"
							value="<%="("+emp.getEmpLat()+", "+emp.getEmpLong()+")"%>" /></div>
					...
					<div class="row">
						...
						<input type="hidden" name="fname" id="fname" value="<%=emp.getEmployeeFirstName()%>" />
							<input type="hidden" name="lname" id="lname" value="<%=emp.getEmployeeLastName()%>" />
							<input type="hidden" id="email" name="email" value="<%=emp.getEmailAddress()%>" />
							<input type="hidden" name="mob" id="mob" value="<%=emp.getContactNumber1()%>" /> 
							<input type="hidden" name="gender" id="gender" 	value="<%=emp.getGender()%>" /></div>
						<input type="hidden" name="personnelNo" id="personnelNo" 	value="<%=emp.getPersonnelNo()%>" /></div>
						</div>
					<%--
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-7 col-xs-6 mar-top-15"><%=emp.getLoginId() %></div>
					...
					<div class="row">
						...
						<div class="col-md-2 col-sm-7 col-xs-6 mar-top-15">
							<input type="text" name="mob" id="mob" value="<%=emp.getContactNumber1()%>" class="form-control" />
						</div>						
					</div>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-7 col-xs-6 mar-top-15 ">						
						<textarea class="addresstextarea form-control" name="addr" id="addr"><%=emp.getAddress() %>
						</textarea>
						</div>
					...
					<div class="row text-right mar-btm-30">
						<div class="col-sm-12">
							<input type="submit" id="save" class="btn btn-blue save-btn" style="visibility: hidden;" value="Save" />
						</div>
					</div>
				</form>
				</div>
...
<script  src="https://code.jquery.com/jquery-2.2.0.js"></script>
	...
	$( document ).ready(function() {
		...
		$('.btn btn-blue save-btn').attr('disabled', 'disabled');
	...
	for (var k = 0; k < markers.length; k++) {
	 ...
	 markers.forEach(function(marker1) {
			...
			function setvalues(){
				...
				document.getElementById("hdtext").innerHTML="Geo coding successful...Please click on Save button to confirm your registration";
