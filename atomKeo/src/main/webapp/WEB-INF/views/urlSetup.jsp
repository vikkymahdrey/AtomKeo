...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#pageEditButton").click(function() {
			...
			$("#page").val($("#pageDrp option:selected").text().trim());
			}
			}catch (e) {
		...
		$("#servletEditButton").click(function() {
			...
			$("#servlet").val($("#servletDrp option:selected").text().trim());
			}
			}catch (e) {
				// TODO: handle exception
				alert(e);
		...
		<div class="content">
			...
			<div style="width:50%; display: inline;">
				...
				<div  style="position: relative; position: (0,0);">
					...
					<br/>
				<div id ="servletLabel" style="margin-left: 18%;"></div>
				...
				<div style = "padding-top:10px; margin-left: 43px;" >
					...
					<select multiple="multiple" name="pageDrp" id="pageDrp"   >
						<c:forEach items="${pagesOnly}" var="page">
				...
				<div id ="servletLabel" style="margin-left: 20%;"></div>
				...
				<div style = "padding-top:20px; margin-left: 43px;"   >
					...
					<select multiple="multiple" name="servletDrp" id="servletDrp"   >
						<c:forEach items="${servletsOnly}" var="page">
								<option value="${page.id}">
									${page.url}
								</option>
								</c:forEach>
