...
<%
		...
		List<Vendormaster> vendorList= (List<Vendormaster>)request.getAttribute("vmList");
...
<%
	...
	%>
	<form id="driverVehicleForm" name="AddVehicleForm" action="driverVehicleSubmit" method="post">
		<table>
			...
			<option value="">-SELECT-</option>
				<%
					for(Vendormaster vm : vendorList){
						%>
