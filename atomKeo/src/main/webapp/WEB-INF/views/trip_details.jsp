...
<body>
	...
	<%		ArrayList<TripDetailsDto> tripSheetList = (ArrayList<TripDetailsDto>)request.getAttribute("tripSheetList");
	...
	<div id="body">
		<div class="content">
			...
			<form action="tripDetailsModify" method="POST">
				<h3>Trip Sheet</h3>
				<hr />
				<p id="top"></p>
				...
				<p>
					<input type="submit" class="formbutton" style="float:left" value="Modify" /> <input
						type="button" class="formbutton" value="Save" onclick="saveTrip()"  style="float:left" />
						<input
				...
				<table border="1" width="80%">
					...
					<tr>
						...
						<input type="button" id="escortchbutton<%=tripDetailsDtoObj.getId() %>" class="formbutton" value="<%=escbuttoncvalue %>" onclick="alterEscort(<%=tripDetailsDtoObj.getId()%>);" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<table border="1" width="80%">
				...
				<tr class="hd">
					...
					<tr class="hd">
						<td>&nbsp</td>
						<td>Assign Vendor</td>
						<td colspan="3"><%=tripDetailsDtoObj.getCompany()%></td>
						<td colspan="3">&nbsp;</td>
						<td>&nbsp;</td>
					</tr> 
			...
			<p>
				<input style="margin-left: 63%" class="formbutton" type="button"
					value="Back"
					onclick="javascript:window.location = 'viewTrips';" />
			</p>
			<br /> <br />
			<hr />
